...
| Name | Notes |
| ---- | ------|
| android_arm64 | Android ARMv8 64-bit (gcc) |
| android_arm64-clang | Android ARMv8 64-bit (clang) |
| android_armv5 |
| android_armv6 |
| android_armv7 | Android ARMv7 (gcc) |
| android_armv7-clang | Android ARMv7 (clang) |
| android_x86 | Android x86 (gcc) |
| android_x86-clang | Android x86 (clang) |
| android_x64 | Android x86_64 64-bit (gcc) |
| android_x64-clang | Android x86_64 64-bit (clang) |
